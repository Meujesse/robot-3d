// Socle commun : mise à l'échelle, voix de Caroline (bouton + mode muet), repérage de l'intégration Genially.
...
export function bulleCaroline(el, texte, fichier){
  el.innerHTML = `<div class="nom">Caroline, votre mentor <button class="ecouter" type="button">${ICONE}<span>Écouter</span></button></div><div class="txt">${texte}</div>`;
